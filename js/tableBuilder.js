...
$('#burger').click(function () {
  ...
  $("tbody tr:last").append($("<td>").text("8.99").addClass('subtotal'));
...
$('#ice_cream').click(function () {
  ...
  $("tbody tr:last").append($("<td>").text("7.99").addClass('subtotal'));
...
$('#pizza').click(function () {
  ...
  $("tbody tr:last").append($("<td>").text("$11.99").addClass('subtotal'));
